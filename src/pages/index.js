...
const IndexPage = () => {
  const animationManager = {
    ...
    buildElements: function() {
      ...
      sparkElements.forEach((spark, index) => {
        ...
        for (var i = 0; i <= sparkCount; i++) {
          let sparkDiv = animationManager.generateSpark(baseAnimationDelay)
    ...
    generateSpark: function(delay) {
      ...
      //create a base delay
      let combinedDelay =
        animationManager.getRandomInt(0, 9) / 10 + parseFloat(delay)
      sparkDiv.style.animationDelay = String(combinedDelay) + "s"
      return sparkDiv
    },
    startIntervalCounter: function() {
      setInterval(() => {
        let materialSVG = document.getElementById("material-group")
          ...
          <div class="component-wrapper">
            ...
            <div class="background-grid">
              <div class="background one">
                <img
                  class=""
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1947284/background-1.svg"
                />
              </div>
              <div class="background two">
                <img
                  class=""
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1947284/background-2.svg"
                />
              </div>
              <div class="background three">
                <img
                  class=""
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1947284/background-3.svg"
                />
              </div>
              <div class="background four">
                <img
                  class=""
                  src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1947284/background-4.svg"
                />
              </div>
            </div>
            ...
            <img
              class="svg-image"
              src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1947284/crane.svg"
            />
            <div class="svg-components">
              ...
              >
                <path
                  id="trolly"
                  class="trolly-movement"
                  d="M661.25,155.5l-6.632-0.507l-0.533,0.694l-1.461,1.697l-4.377-0.313l-2.711-0.194l-1.037,0.437l-1.51-0.078l0.26-0.486
              ...
              >
                <path
                  ...
                  stroke-linecap="null"
                  stroke-opacity="null"
                  d="m648.984268,232.200277l23.640917,19.5284"
                  id="svg_6"
                />
                <path
                  fill-opacity="null"
                  ...
                  stroke-linecap="null"
                  stroke-opacity="null"
                  d="m648.586944,232.497402l32.580756,19.5284"
                  id="svg_4"
                />
                <path
                  fill-opacity="null"
                  ...
                  stroke-linecap="null"
                  stroke-opacity="null"
                  d="m648.586944,232.93624l-31.586942,19.089562"
                  id="svg_7"
                />
                <path
                  fill-opacity="null"
                  ...
                  stroke-linecap="null"
                  stroke-opacity="null"
                  d="m648.806102,232.716821l-24.137061,19.089562"
                  id="svg_8"
                />
                <path
                  stroke="null"
                ...
                <path
                  ...
                  stroke-linecap="null"
                  stroke-opacity="null"
                  d="m617.198193,252.025815l63.969496,0l0,21.283765l-63.969496,0l0,-21.283765z"
                  id="svg_16"
                />
              </svg>
            </div>
